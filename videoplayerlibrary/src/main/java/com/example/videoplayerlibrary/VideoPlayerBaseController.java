...
public abstract class VideoPlayerBaseController extends FrameLayout  implements View.OnTouchListener {
     ...
     *                  <ul>
     *                  <li>{@link EyeVideoPlayer#STATE_IDLE}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_PREPARING}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_PREPARED}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_PLAYING}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_PAUSED}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_BUFFERING_PLAYING}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_BUFFERING_PAUSED}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_ERROR}</li>
     *                  <li>{@link EyeVideoPlayer#STATE_COMPLETED}</li>
     *                  </ul>
     */
     ...
     *                 <ul>
     *                 <li>{@link EyeVideoPlayer#MODE_NORMAL}</li>
     *                 <li>{@link EyeVideoPlayer#MODE_FULL_SCREEN}</li>
     *                 <li>{@link EyeVideoPlayer#MODE_TINY_WINDOW}</li>
     *                 </ul>
     */
