package com.example.videoplayerlibrary.simplevideo;
...
public class VideoPlayerManage {
    ...
    private static final int VIDEO_SYS = 11;
    private static final int VIDEO_ALI = 22;
    private static final int VIDEO_IJK = 33;
    private static final int VIDEO_EXO = 44;
    private int videoType = VIDEO_SYS;
